...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box" style="padding: 10px 24px">
            <form action="{{ route('admin.users.import_excel') }}" class="ajaxForm" method="post" id="excel_form" enctype="multipart/form-data">
                @csrf
                <div class="row">
    ...
    <div class="col-lg-12">
        <div class="card-box">
            <table class="table table-bordered w-100 nowrapp table-responsive" id="online_users">
                <thead>
                    <tr>
                        <th width="20">#</th>
                        <th>Task ID</th>
...
<script>
    $(document).ready(function(){
        ...
        var table =      $('#online_users').DataTable({
                            ...
                            ajax:{
                                url : "{{ route('admin.users.all_imported') }}",
                                data:function(d){
        ...
        $('#export_btn').click(function(){
            $('#export_form').attr('action', "{{ route('admin.users.export_user_tmp') }}");
