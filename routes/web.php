...
Route::namespace('Administrator')->middleware('auth:admin')->name('admin.')->group(function () {
    ...
    Route::prefix('users')->name('users.')->group(function(){
        ...
        Route::get('/remarks/{id}', 'UserController@deleteRemark')->name('delete_remark');
    ...
    Route::prefix('accounts')->name('accounts.')->group(function(){
        ...
        Route::prefix('payments')->name('payments.')->group(function(){
            ...
            Route::get('/rejected-payments', 'PaymentController@rejectedPayments')->name('rejected_payments');
